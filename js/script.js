...
window.addEventListener('DOMContentLoaded', () => {
	...
	const philosophers = [
		// добавь реальные id в каждый объект философа
		{
			id: 1,
			name: "Буслаев Р.В1",
            ...
            humanFollowers : [2 , 4],
            followHumans : [3],
			school: "Классическая турецкая философия",
